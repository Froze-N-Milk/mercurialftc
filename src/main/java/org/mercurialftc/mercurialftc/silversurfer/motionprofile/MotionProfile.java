...
public class MotionProfile {
	...
	private Followable.Output[] finaliseProfile() { // todo figure out return type, should probably be Followable.Output, but that might need modifying
...
//			c1 = c;
	...
	public double[] findIntersects() {
		...
		// TODO: handle first case, i think stuff should all be 0...
		// todo store output
	...
	private double findThreshIntersect(int i, double curvatureI, double curvatureI_1) { // todo may only need to work for considering differential drives??, needs consideration
