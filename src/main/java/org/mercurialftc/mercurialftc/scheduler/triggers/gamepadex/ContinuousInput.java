...
public class ContinuousInput {
	 ...
	 * <p>non-mutating</p>
	 *
	 * @return a new continuous input, with the input values inverted, has none of the features applied to the original
	 */
	public ContinuousInput invert() {
		return new ContinuousInput(() -> -input.getAsDouble());
	}
}
