...
public class MecanumArbFollower extends ArbFollower {
	...
	/**
	 * transforms the output for use in {@link #follow(Vector2D, double)} and then feeds it in
	 *
	...
	protected void followOutput(@NotNull Followable.Output output, double loopTime) {
		...
		follow(translationVector, rotationalVelocity);
	}
	 ...
	 */
	@Override
	public void follow(@NotNull Vector2D translationVector, double rotationalVelocity) {
